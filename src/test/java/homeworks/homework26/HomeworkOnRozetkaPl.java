...
public class HomeworkOnRozetkaPl extends WebDriverInit {
    ...
    private void goToLaptopsSection() {
        WebElement laptopsAndTabletsCategory = webDriverWait.until(ExpectedConditions.visibilityOfElementLocated(
                By.xpath("(//a[@class='menu-categories__link'])[1]")));
        laptopsAndTabletsCategory.click();
        WebElement laptopsCategory = webDriverWait.until(ExpectedConditions.elementToBeClickable(
                By.xpath("(//a[@class='portal-navigation__link'])[1]")));
        laptopsCategory.click();
    }

    private void applyBrandFilter() {
        WebElement brandFilter = webDriverWait.until(ExpectedConditions.elementToBeClickable(
    ...
    private void goToFirstProductWithActionLabel(String expectedActionLabel) {
        List<WebElement> productsWithActionLabel = webDriverWait.until(ExpectedConditions.presenceOfAllElementsLocatedBy(
        ...
        productName.click();
        webDriverWait.until(ExpectedConditions.urlContains("p383969898"));
    }
